          ...
          <div className="relative mb-4 overflow-hidden rounded-xl">
            ...
            <div className="absolute top-2 flex w-full items-center justify-between px-2">
              <div className="flex items-center rounded-xl bg-white px-2">
                ...
                <span className="ml-1 font-semibold text-emerald-700">10</span>
              </div>
              <div className="flex items-center rounded-xl bg-white px-2">
                ...
                <span className="ml-1 font-semibold text-emerald-700">20</span>
              </div>
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="inline-flex items-center">
                  ...
                  <span className="font-semibold text-slate-200">Night</span>
                </div>
              </div>
            </button>
          </div>
